...
('Micro cravate', '','13','fa-solid fa-volume-high-high','bon','2'),
('Micro cravate', '','14','fa-solid fa-volume-high-high','bon','2'),
('Micro cravate', '','15','fa-solid fa-volume-high-high','bon','2'),
('Micro cravate', '','16','fa-solid fa-volume-high-high','bon','2'),
('Micro cravate', '','17','fa-solid fa-volume-high-high','bon','2'),
('Micro', 'SENNHEISER','18','fa-solid fa-volume-high-high','bon','2'),
('Micro', 'SENNHEISER','19','fa-solid fa-volume-high-high','bon','2'),
('Micro', 'SENNHEISER','20','fa-solid fa-volume-high-high','bon','2'),
('Table de mixage ALTO', 'LIVE 1202','21','fa-solid fa-volume-high-high','bon','2'),
('Caisse de basses', 'THE BOX','22','fa-solid fa-volume-high-high','bon','2'),
('Enceinte', 'THE BOX','23','fa-solid fa-volume-high','bon','2'),
('Enceinte', 'THE BOX','24','fa-solid fa-volume-high','bon','2'),
('Transmetteur ', 'SENNHEISER','25','fa-solid fa-volume-high-high','bon','2'),
('Transmetteur ', 'SENNHEISER','26','fa-solid fa-volume-high-high','bon','2'),
('Transmetteur ', 'SENNHEISER','27','fa-solid fa-volume-high-high','bon','2'),
('Transmetteur ', 'SENNHEISER','28','fa-solid fa-volume-high-high','bon','2'),
('Transmetteur ', 'SENNHEISER','29','fa-solid fa-volume-high-high','bon','2'),
('Casque micro', 'Jabra','30','fa-solid fa-volume-high-high','bon','2'),
('Casque micro', 'JCV','31','fa-solid fa-volume-high-high','bon','2'),
...
('Enceinte Portable','Fenton','62','fa-solid fa-volume-high-high','bon','2'),
('Micro','Fenton','63','fa-solid fa-volume-high-high','bon','2');
