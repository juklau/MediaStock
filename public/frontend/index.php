  ...
  <body class="d-flex flex-column min-vh-100">
    ...
    <div class="container py-4 flex-grow-1">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-center actions-row">
        <button class="btn action-btn w-100 w-md-auto" id="scanPretBtn">Crée un prêt</button>
        <button class="btn action-btn w-100 w-md-auto" id="scanRestitutionBtn">Crée une restitution</button>
      </div>
    </div>
    ...
    <div class="container py-4 flex-grow-1">
      ...
      <div class="row g-2 mb-3 toolbar">
        <div class="col-12 col-md-auto">       
            <button class="btn btn-primary w-100" window onclick="location.href='Choixcat.html'">
      ...
      <div class="offcanvas-body p-0">
        ...
        <div class="fiche-header">
          <div class="fiche-icon-wrapper">
            <div id="ficheIcon" class="fiche-icon-circle"><i class="fas fa-box fa-3x"></i></div>
          </div>
        ...
        <div class="fiche-content">
          ...
          <div class="fiche-card">
            <div class="fiche-card-header"><i class="fas fa-qrcode me-2"></i>
            ...
            <div class="fiche-card-body text-center">
              ...
              <p class="text-muted small mt-2 mb-0">Scannez pour accéder aux détails</p>
            </div>
          </div>

          <!-- Historique Card -->
          <div class="fiche-card">
            <div class="fiche-card-header"><i class="fas fa-history me-2"></i>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center p-3">
          <div class="modal-body">
            <p class="mb-2">Etes vous bien sûr de vouloir supprimer cette élément ?</p>
          ...
          <div class="modal-footer justify-content-center">
            ...
            <button id="confirmDeleteBtn" type="button" class="btn">validé</button>
          </div>
        </div>
      </div>
    </div>
      ...
      function startQrScan() {
        ...
        html5QrCode.start(
            ...
            async (decodedText) => {
                ...
                try {
                    const resp = await fetch(`../api/getPageByQRCode.php?code=${encodeURIComponent(decodedText)}`);
                    const data = await resp.json();
                    
                    if(data.success && data.targetPage){
                        // Redirection vers la page renvoyée par l'API
                        window.location.href = data.targetPage + `?code=${encodeURIComponent(decodedText)}`;
                    } else {
